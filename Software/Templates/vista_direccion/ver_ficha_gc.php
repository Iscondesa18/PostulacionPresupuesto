        ...
        <form action="" id="formulario_gastos_corriente" method="POST">
            ...
            <div class="row">
              ...
              <div class="col" style="display: none;">
                <textarea class="form-control form-control--edit"id="id_detalle"    value="<?=$datos->id_detalle_ficha?>"name="id_detalle" rows="3"  readonly ><?=$datos->id_detalle_ficha?></textarea>
              </div>
              <div class="col">
